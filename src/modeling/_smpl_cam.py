...
class SMPLModel(Module):
    def __init__(self, device=None, model_path=cfg.SMPL_FILE,
        ...
        self.joint_regressor = torch.from_numpy(
            np.load(cfg.folder_path + 'data/J_regressor_lsp.npy')).type(self.dtype)
    ...
    def forward(self, betas=None, thetas=None, trans=None, scale=None, gR=None, lsp=True):
